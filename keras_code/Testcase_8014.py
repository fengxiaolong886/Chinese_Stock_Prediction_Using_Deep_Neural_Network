...
model1.add(layers.Bidirectional(layers.LSTM(32,activation="tanh",dropout=0.5,return_sequences=True)))
model1.add(layers.Bidirectional(layers.LSTM(32,activation="tanh",dropout=0.5,return_sequences=True)))
model1.add(layers.Bidirectional(layers.LSTM(32,activation="tanh",dropout=0.5,return_sequences=True)))
model1.add(layers.Bidirectional(layers.LSTM(32,activation="tanh",dropout=0.5)))
