...
model1.add(layers.Bidirectional(layers.LSTM(32,activation="tanh",return_sequences=True)))
model1.add(layers.Bidirectional(layers.LSTM(32,activation="tanh",return_sequences=True)))
model1.add(layers.Bidirectional(layers.LSTM(32,activation="tanh",return_sequences=True)))
model1.add(layers.Bidirectional(layers.LSTM(32,activation="tanh")))
